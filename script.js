...
function renderCartItems() {
    ...
    let deliveryCharges = cart.length > 0 ? 350 : 0;
    ...
    if (cart.length > 0) {
        deliveryHTML = `
            <div style="display: flex; justify-content: space-between; padding: 10px 5px; color: #666; font-size: 0.9rem; border-top: 1px solid #eee; margin-top: 5px;">
                <span>Delivery Charges:</span>
                <span>Rs ${deliveryCharges}</span>
            </div>`;
    }
   container.innerHTML = cartHTML + deliveryHTML; 
